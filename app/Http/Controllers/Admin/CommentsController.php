...
class CommentsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.comments.create', compact('images', 'sounds', 'videos', 'users'));
    }
    ...
    public function edit(Comment $comment)
    {
        ...
        $comment->load('image', 'sound', 'video', 'user');

        return view('admin.comments.edit', compact('images', 'sounds', 'videos', 'users', 'comment'));
    }
