    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keyEn') ? 'is-invalid' : '' }}" type="text" name="keyEn" id="keyEn" value="{{ old('keyEn', $setting->keyEn) }}" required>
                @if($errors->has('keyEn'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keyAr') ? 'is-invalid' : '' }}" type="text" name="keyAr" id="keyAr" value="{{ old('keyAr', $setting->keyAr) }}" required>
                @if($errors->has('keyAr'))
                    <div class="invalid-feedback">
                        {{ $errors->first('keyAr') }}
                    </div>
