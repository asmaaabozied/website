    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.seos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_title') ? 'is-invalid' : '' }}" type="text" name="seo_title" id="seo_title" value="{{ old('seo_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('seo_keywords') ? 'is-invalid' : '' }}" type="text" name="seo_keywords" id="seo_keywords" value="{{ old('seo_keywords', '') }}">
