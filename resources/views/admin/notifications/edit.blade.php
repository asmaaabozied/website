    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.notifications.update", [$notification->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alert_text') ? 'is-invalid' : '' }}" type="text" name="alert_text" id="alert_text" value="{{ old('alert_text', $notification->alert_text) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Notification::ALERT_TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('alert_type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="alert_type_{{ $key }}" name="alert_type" value="{{ $key }}" {{ old('alert_type', $notification->alert_type) === (string) $key ? 'checked' : '' }} required>
                        <label class="form-check-label" for="alert_type_{{ $key }}">{{ $label }}</label>
                    </div>
                @endforeach
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('media_number') ? 'is-invalid' : '' }}" type="text" name="media_number" id="media_number" value="{{ old('media_number', $notification->media_number) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('message_details') ? 'is-invalid' : '' }}" type="text" name="message_details" id="message_details" value="{{ old('message_details', $notification->message_details) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attachments_message') ? 'is-invalid' : '' }}" type="text" name="attachments_message" id="attachments_message" value="{{ old('attachments_message', $notification->attachments_message) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('link') ? 'is-invalid' : '' }}" type="text" name="link" id="link" value="{{ old('link', $notification->link) }}">
                @if($errors->has('link'))
                    <div class="invalid-feedback">
                        {{ $errors->first('link') }}
                    </div>
