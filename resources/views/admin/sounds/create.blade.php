...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.sound.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sounds.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <label for="notify">{{ trans('cruds.sound.fields.notify') }}</label>
            </div>
            <div class="form-group">
