...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.subDomian.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.sub-domians.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="titleEn">{{ trans('cruds.subDomian.fields.titleEn') }}</label>
                <input class="form-control {{ $errors->has('titleEn') ? 'is-invalid' : '' }}" type="text" name="titleEn" id="titleEn" value="{{ old('titleEn', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('titleAr') ? 'is-invalid' : '' }}" type="text" name="titleAr" id="titleAr" value="{{ old('titleAr', '') }}" required>
